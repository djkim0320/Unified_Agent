...
The UI shows config source labels, configured server count, risk warnings, copyable config snippets, and "테스트 Run 생성" actions. Absolute local config paths stay hidden unless debug path exposure is explicitly enabled.
